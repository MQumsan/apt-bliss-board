...
const translations = {
  en: {
    ...
    chequeCleared: 'Cheque cleared & income recorded',
    overdueCheques: 'Overdue Cheques',
    bouncedCheques: 'Bounced Cheques',
    noBouncedCheques: 'No bounced cheques',
    // Reports
    ...
    buildingNameAr: 'Building Name (Arabic)',
    logout: 'Logout',
  },
  ar: {
    ...
    markAsCleared: 'تحصيل الشيك',
    chequeCleared: 'تم تحصيل الشيك وتسجيل الإيراد',
    overdueCheques: 'شيكات متأخرة',
    bouncedCheques: 'شيكات مرتجعة',
    noBouncedCheques: 'لا توجد شيكات مرتجعة',
    // Reports
